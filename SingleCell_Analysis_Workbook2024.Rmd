...
```{r}
saveRDS(con_seu.ft, paste(file_path,"control_start_seu.rds"))
saveRDS(snca_seu.ft, paste(file_path,"snca_start_seu.rds"))
...
con_seu.ft <- readRDS(paste(file_path,"control_start_seu.rds")) 
snca_seu.ft <-readRDS(paste(file_path,"snca_start_seu.rds"))
...
VariableFeaturePlot(con_seu.ft)
disp_var  <- VariableFeatures(con_seu.ft)
